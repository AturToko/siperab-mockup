      ...
      <main class="col-12 col-md-6 ms-sm-auto">
        ...
        <div class="vh-100 d-flex flex-column justify-content-center align-items-center mx-auto w-100">
          <div class="text-center mb-4 w-75">
            ...
            <h1 class="h4 mb-3 fw-bold">Reset Password</h1>
          </div>
          <form class="w-75">
            <div class="mb-3">
            ...
            <div class="mb-3">
              <label for="confirmPass" class="form-label fw-bold">Password Baru</label>
              <input type="password" id="confirmPass" name="confirmPass" class="form-control" placeholder="Konfirmasi Password Baru" required>
            </div>
            <br>
