<?php include('header.php'); ?>
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 mt-2 mb-5 position-relative h-100">
                    ...
                    <tr class="lh-lg">
                      ...
                      <td>
                        <button class="btn rounded-3 bg-success text-white text-sm action-button fs-6 p-2"
                          data-bs-toggle="modal" data-bs-target="#addTag"><i class="fas fa-edit"></i></button>
        ...
        <!-- Modal Window to Create or Edit Tag -->
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header main-gradient text-white">
                <h1 class="modal-title fs-5" id="staticBackdropLabel">Entri/Edit Data Tag/Jenis</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <div class="mb-3">
                  <label for="namaTag" class="form-label">Tag/Jenis <sup class="text-danger">*</sup></label>
                  <input type="text" class="form-control" id="namaTag" placeholder="isi dengan nama tag/jenis">
                </div>
              </div>
        ...
        <div class="modal fade" id="deleteConfirm" aria-hidden="true" aria-labelledby="deleteConfirmLabel" tabindex="-1">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header main-gradient text-white">
                <h1 class="modal-title fs-6" id="deleteConfirmLabel">Hapus Tag/Jenis</h1>
              </div>
              <div class="modal-body">
                Anda yakin ingin menghapus data {nama_tag}?
              </div>
              <div class="modal-footer">
