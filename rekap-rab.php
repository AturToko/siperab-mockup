            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="catatan" placeholder="isi dengan catatan (opsional)">
                </div>
                <div class="mb-3">
                  <label for="eksporKe" class="form-label fw-bold">Ekspor Ke <sup class="text-danger">*</sup></label>
                  <br>
