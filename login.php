...
<!-- <body>
  <div class="container-fluid">
    <div class="row">
      ...
      <main class="col-6 ms-sm-auto">

        <div class="vh-100 d-flex flex-column justify-content-center align-items-center mx-auto w-50">
          <div class="text-center mb-4 w-75">
            <img src="img/logo.png" alt="SIPERAB Logo" width="250" class="mb-5">
            <h1 class="h4 mb-3 fw-normal">Sign In</h1>
            <h2 class="h5 mb-3 fw-normal">Selamat Datang</h2>
          </div>
          <form class="w-75">
            <div class="mb-3">
              <label for="username" class="form-label">Email/Phone</label>
              <input type="text" id="username" class="form-control" placeholder="Masukkan Email/Phone" required>
            </div>
            <div class="mb-3">
